...
const P = React.forwardRef<TextRef, SlottableTextProps>(
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Component
                className={cn(
                    'text-base text-text font-serif web:select-text',
                    className,
                )}
                ref={ref}
                {...props}
    ...
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Component
                ...
                className={cn(
                    'mt-6 native:mt-4 border-l-2 border-border pl-6 native:pl-3 text-base text-text font-serif italic web:select-text',
                    className,
                )}
                ref={ref}
                {...props}
    ...
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Component
                ...
                className={cn(
                    'relative rounded-md bg-bw px-[0.3rem] py-[0.2rem] text-sm text-text font-semibold font-serif web:select-text',
                    className,
                )}
                ref={ref}
                {...props}
...
const Lead = React.forwardRef<TextRef, SlottableTextProps>(
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Component
                className={cn(
                    'text-xl text-text font-serif web:select-text',
                    className,
                )}
                ref={ref}
                {...props}
...
const Large = React.forwardRef<TextRef, SlottableTextProps>(
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Component
                className={cn(
                    'text-xl text-text font-serif font-semibold web:select-text',
                    className,
                )}
                ref={ref}
                {...props}
...
const Small = React.forwardRef<TextRef, SlottableTextProps>(
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Component
                className={cn(
                    'text-sm text-text font-serif font-medium leading-none web:select-text',
                    className,
                )}
                ref={ref}
                {...props}
...
const Muted = React.forwardRef<TextRef, SlottableTextProps>(
    ({ className, asChild = false, ...props }, ref) => {
        ...
        return (
            <Component
                className={cn(
                    'text-sm text-text font-serif web:select-text',
                    className,
                )}
                ref={ref}
                {...props}
